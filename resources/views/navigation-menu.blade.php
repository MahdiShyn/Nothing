    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @elseif(@Auth::user()->action == 'employee')
                    @if(@Auth::user()->employee->action == 'accountant')
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <x-jet-nav-link href="{{ route('home') }}" :active="request()->routeIs('dashboard')">
                                Home
                            </x-jet-nav-link>
                    ...
                    @elseif(@Auth::user()->employee->action == 'deskclerk')
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <x-jet-nav-link href="{{ route('home') }}" :active="request()->routeIs('dashboard')">
                                Home
                            </x-jet-nav-link>
                    ...
                    @elseif(@Auth::user()->employee->action == 'worker')
                        {{--  --}}
                    @endif
                @endif
            </div>
